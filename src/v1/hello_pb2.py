...
_EMPTYREQUEST = _descriptor.Descriptor(
  name='EmptyRequest',
  full_name='devision.hello.v1.EmptyRequest',
  filename=None,
  file=DESCRIPTOR,
...
_EMPTYRESPONSE = _descriptor.Descriptor(
  name='EmptyResponse',
  full_name='devision.hello.v1.EmptyResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_ECHOREQUEST = _descriptor.Descriptor(
  name='EchoRequest',
  full_name='devision.hello.v1.EchoRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='devision.hello.v1.EchoRequest.name', index=0,
...
_ECHORESPONSE = _descriptor.Descriptor(
  name='EchoResponse',
  full_name='devision.hello.v1.EchoResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='server_id', full_name='devision.hello.v1.EchoResponse.server_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='devision.hello.v1.EchoResponse.name', index=1,
...
_PINGREQUEST = _descriptor.Descriptor(
  name='PingRequest',
  full_name='devision.hello.v1.PingRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ping', full_name='devision.hello.v1.PingRequest.ping', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PINGRESPONSE = _descriptor.Descriptor(
  name='PingResponse',
  full_name='devision.hello.v1.PingResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ping', full_name='devision.hello.v1.PingResponse.ping', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
EmptyRequest = _reflection.GeneratedProtocolMessageType('EmptyRequest', (_message.Message,), dict(
  ...
  __module__ = 'v1.hello_pb2'
  # @@protoc_insertion_point(class_scope:devision.hello.v1.EmptyRequest)
  ))
...
EmptyResponse = _reflection.GeneratedProtocolMessageType('EmptyResponse', (_message.Message,), dict(
  ...
  __module__ = 'v1.hello_pb2'
  # @@protoc_insertion_point(class_scope:devision.hello.v1.EmptyResponse)
  ))
...
EchoRequest = _reflection.GeneratedProtocolMessageType('EchoRequest', (_message.Message,), dict(
  ...
  __module__ = 'v1.hello_pb2'
  # @@protoc_insertion_point(class_scope:devision.hello.v1.EchoRequest)
  ))
...
EchoResponse = _reflection.GeneratedProtocolMessageType('EchoResponse', (_message.Message,), dict(
  ...
  __module__ = 'v1.hello_pb2'
  # @@protoc_insertion_point(class_scope:devision.hello.v1.EchoResponse)
  ))
...
PingRequest = _reflection.GeneratedProtocolMessageType('PingRequest', (_message.Message,), dict(
  ...
  __module__ = 'v1.hello_pb2'
  # @@protoc_insertion_point(class_scope:devision.hello.v1.PingRequest)
  ))
...
PingResponse = _reflection.GeneratedProtocolMessageType('PingResponse', (_message.Message,), dict(
  ...
  __module__ = 'v1.hello_pb2'
  # @@protoc_insertion_point(class_scope:devision.hello.v1.PingResponse)
  ))
_sym_db.RegisterMessage(PingResponse)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\024io.devision.hello.v1B\022HelloServicesProtoP\001\210\001\001\312\002\021Devision\\Hello\\V1'))

_HELLO = _descriptor.ServiceDescriptor(
  name='Hello',
  full_name='devision.hello.v1.Hello',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Echo',
    full_name='devision.hello.v1.Hello.Echo',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Ping',
    full_name='devision.hello.v1.Hello.Ping',
    index=1,
    containing_service=None,
